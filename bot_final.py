Вот полный, окончательно собранный код твоего бота. Я включил сюда все: 78 карт, обновленное приветствие, глубокий промпт для ИИ, секретное меню отладки для тебя и финальную фразу для клиентов.

Просто скопируй этот текст целиком в свой файл bot.py и запушь на GitHub.
